...
def shift_subgrid_x(grid: Grid[Nx, Ny], x_indices: ilist.IList[int, typing.Any], x_shift: float) -> Grid[Nx, Ny]:
...
def shift_subgrid_y(grid: Grid[Nx, Ny], y_indices: ilist.IList[int, typing.Any], y_shift: float) -> Grid[Nx, Ny]:
